...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="px-4 py-5 w-full">
      <RevealOnScroll>
          ...
          >
            <div className="relative">
              <input
                ...
                required
                value={formData.name}
                className="w-full bg-white/5 border border-white/20 rounded px-4 py-2 md:py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5"
                placeholder="Name..."
                onChange={(e) =>
